...
public sealed record PlayerSettingsData(string StartSection="home",bool ConfirmExit=true,bool AutoReconnect=true,string DefaultAspect="fill",string FocusStrength="normal",bool SubtitlesEnabled=true,string PreferredAudioLanguage="auto",string PreferredSubtitleLanguage="auto",string CatalogStart="recent",string AppLanguage="ar");
